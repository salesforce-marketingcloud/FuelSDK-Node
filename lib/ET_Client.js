...
function _getSoapBaseUrl(client, soapOrigin, globalReqOptions, callback) {
...
var ET_Client = function(clientId, clientSecret, stack, {origin, authOrigin, soapOrigin, globalReqOptions = {}} = {}) {
    ...
    if (typeof stack === 'string') {
        console.warn('The stack is no longer supported. Please use authOrigin property instead.')
    }
	...
	this.SoapClient = this.initSoap(clientId, clientSecret, origin, authOrigin, soapOrigin, globalReqOptions);
...
ET_Client.prototype.initSoap = function(clientId, clientSecret, origin, authOrigin, soapOrigin, globalReqOptions) {
    ...
    ['create', 'retrieve', 'update', 'delete'].forEach(method => { // for each method
        client[method] = function () {
            ...
            _getSoapBaseUrl(client, soapOrigin, globalReqOptions, () => { // get the custom base url
