...
var ET_Client = function(clientId, clientSecret, stack, {origin, authOrigin, soapOrigin, authOptions = {}, globalReqOptions = {}} = {}) {
    ...
    if(authOptions && !authOrigin && authOptions.authVersion === 2){
        throw new Error('authOrigin is mandatory for Auth Version 2 (OAuth2 Authentication)');
    }
    if (!origin) {
