...
function _getSoapBaseUrl(client, stack, globalReqOptions, callback) {
...
var ET_Client = function(clientId, clientSecret, stack, origin, authOrigin, {globalReqOptions = {}} = {}) {
	...
	this.SoapClient = this.initSoap(clientId, clientSecret, stack, origin, authOrigin, globalReqOptions);
...
ET_Client.prototype.initSoap = function(clientId, clientSecret, stack, origin, authOrigin, globalReqOptions) {
    ...
    ['create', 'retrieve', 'update', 'delete'].forEach(method => { // for each method
        client[method] = function () {
            ...
            _getSoapBaseUrl(client, stack, globalReqOptions, () => { // get the custom base url
